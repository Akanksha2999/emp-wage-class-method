...
class EmpWage implements InterfaceEmpWage {
    ...
    public static void main(String[] args) {
        ...
        empWage.addCompanyEmpWage("Bridgelabz", 20, 20, 100);
        empWage.addCompanyEmpWage("Hike", 10, 15, 100);
        empWage.addCompanyEmpWage("Rising", 25, 20, 80);
